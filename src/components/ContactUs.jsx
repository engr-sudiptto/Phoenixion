    ...
    <div id="contact">
      ...
      <form className="w-full p-3 lg:px-15 xl:w-3/4 xl:m-auto 2xl:w-1/2 pt-10">
        <div className="lg:grid lg:grid-cols-2 lg:gap-5">
          {/* ==== name input ====== */}
          <div className="">
            <p className="text-sm text-gray-500 mt-5 mb-3">Your Name</p>
            <div className="flex items-center border px-2 rounded-md border-gray-400 h-10">
          ...
          {/* ======== email input =======  */}
          <div>
            <p className="text-sm text-gray-500 mt-5 mb-3">Email Id</p>
            <div className="flex items-center border px-2 rounded-md border-gray-400 h-10 mb-5">
              <img
        ...
        <p className="text-sm text-gray-500 mt-5 mb-3">Message</p>
        <textarea
          name="message"
